...
class AdminMenuConfigTableSeeder extends Seeder
{
    /**
    ...
    protected $admin_menu_configuration = [
        [
            "title" => "Tổng quan",
    ...
    public function run()
    {
        AdminMenuConfiguration::insert([
            ["value" => json_encode($this->admin_menu_configuration)],
        ]);
    }
}
